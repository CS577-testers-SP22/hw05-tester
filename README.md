...
Additional tests for CS577 Spring 2022 HW05: Divide & Conquer
...
### Option 1: Clone the entire repo
 ...
 - Run `$ git clone https://github.com/CS577-testers-SP22/hw05-tester/`
 - Copy your code and `Makefile` into the repo

### Option 2: Download specific files

 - Download [tests.json](tests.json) and [hw05-test.py](hw05-test.py) into the directory that contains your `Makefile` and code.
...
where `source_code` is the file(s) you'd submit to Gradescope with your `Makefile`. Mine is `Inversions.cpp`, but you might have `hw05.py`, `Main.java`, or something else.
